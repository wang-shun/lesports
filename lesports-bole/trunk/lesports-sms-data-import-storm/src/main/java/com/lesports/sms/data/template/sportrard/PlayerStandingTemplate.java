 ...
 */
public class PlayerStandingTemplate extends XmlTemplate {
    @XPath("//ns2:SportradarData/Sport/Category/Tournament/Teams")
    private List<SportrardPlayerStanding> liveScores;

    @Override
    public List<Object> getData() {
        List<Object> res= Lists.newArrayList();
        for (SportrardPlayerStanding liveScore : liveScores) {
            res.add(liveScore);
        }
        return res;
    }
