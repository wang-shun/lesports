...
public class DefaultTopListProcessor extends BeanProcessor {
    ...
    public Boolean process(Object object) {
        ...
        try {
            ...
            query.addCriteria(new InternalCriteria("scope_id", "is", newTopList.getScopeId()));
            query.addCriteria(new InternalCriteria("competitor_type", "eq", newTopList.getCompetitorType()));
