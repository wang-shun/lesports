...
public class AladCooperationJob {
    ...
    @Resource
    private BaiduCupStatsService baiduCupStatsService;
    @Resource
    private BaiduWiseStatsService baiduWiseStatsService;
    @Resource
    private OneboxAfcclStatsService oneboxAfcclStatsService;
    @Resource
    private OneboxAfcclMobStatsService oneboxAfcclMobStatsService;
     ...
     *  baidu affccl  pc数据
     */
    public void baiduAfcclStats() {
        logger.info("【baidu affccl pc   Stats】 start");
        baiduCupStatsService.baiduCupStats(100234001L,"2017afccl");
        logger.info("【baidu affccl pc   Stats】 end");
    }
     ...
     * 360亚冠pc
     */
    public void oneboxAfcclStats() {
        if(Constants.quarzflag){
            logger.info("【oneboxAfccl Stats】 start");
            oneboxAfcclStatsService.oneboxAfcclStats(100234001L,"onebox2017afccl");
            logger.info("【oneboxAfccl Stats】 end");
        }
    }
     ...
     * 360亚冠移动
     */
    public void oneboxAfcclMobStats() {
        if(Constants.quarzflag){
            logger.info("【oneboxAfccl mob Stats】 start");
            oneboxAfcclMobStatsService.oneboxAfcclMobStats(100234001L,"onebox2017afccl_mob");
            logger.info("【oneboxAfccl mob Stats】 end");
        }
    }
