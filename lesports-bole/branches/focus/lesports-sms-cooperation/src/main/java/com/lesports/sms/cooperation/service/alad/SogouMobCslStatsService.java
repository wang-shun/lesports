 ...
 */
@Service("sogouMobCslStatsService")
public class SogouMobCslStatsService {
    private static final Logger LOG = LoggerFactory.getLogger(SogouMobCslStatsService.class);
    //每个文件最多条数
    ...
    public void sogouCslStats() {
        ...
        String fileName = "sogou2016csl_mobile"+Constants.fileextraname+".xml";
...
//            LOG.info("tComboEpisode: {} , time: {}", episode.getName(), episode.getStartTime());
    ...
    public Element createOneContentElement(Match match,TComboEpisode episode) throws Exception{
        ...
        link.addContent(new CDATA("http://www.lesports.com/team/"+homeTeam.getId()+".html?ch=sogou_csl"));
        ...
        Element url = new Element("url");
        url.addContent(new CDATA("http://m.sports.le.com/match/"+match.getId()+".html??ch=sogou_csl"));
        ...
        link.addContent(new CDATA("http://www.lesports.com/team/"+awayTeam.getId()+".html?ch=sogou_csl"));
    ...
    public Element createScoreToplistElement(TopList topList) throws Exception{
        ...
        more.addContent(new CDATA("http://m.sports.le.com/csl/toplist.html?ch=sogou_csl"));
