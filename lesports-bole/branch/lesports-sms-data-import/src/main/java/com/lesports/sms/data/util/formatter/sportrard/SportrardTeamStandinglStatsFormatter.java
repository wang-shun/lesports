 ...
 */
public class SportrardTeamStandinglStatsFormatter extends ElementFormatter implements Function<Element, Map<String, Object>> {
    @Nullable
    @Override
    public Map<String, Object> apply(Element input) {
        return parseElementwithFunction(input, SportrardConstants.teamStandingStatPath);
    }
}