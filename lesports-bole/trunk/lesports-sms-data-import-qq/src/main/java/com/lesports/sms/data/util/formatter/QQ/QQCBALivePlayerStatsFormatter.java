 ...
 */
public class QQCBALivePlayerStatsFormatter implements Function<Object, Map<String, Object>> {
    @Nullable
    @Override
        ...
        if (JSONArray.class.isAssignableFrom(input.getClass())) {
            ...
            if (arrays != null && arrays.size() > 0) {
                ...
                stats.put("freethrows_attempted", freeThrowPointGoas[1]);
                  stats.put("offensive_rebounds", "");
                  stats.put("defensive_rebounds", "");
                stats.put("steals", arrays.get(9));
                stats.put("blockedshots", arrays.get(10));
                stats.put("turnovers", getArrayValue(arrays, 11));
                stats.put("personalfouls", getArrayValue(arrays, 12));
            }
        }
        return stats;
    }
