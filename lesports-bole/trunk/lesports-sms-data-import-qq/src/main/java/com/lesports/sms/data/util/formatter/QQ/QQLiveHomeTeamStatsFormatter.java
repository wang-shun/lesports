 ...
 */
public class QQLiveHomeTeamStatsFormatter implements Function<Object, Map<String, Object>> {
    @Nullable
    @Override
    public Map<String, Object> apply(Object input) {
        ...
        if (JSONArray.class.isAssignableFrom(input.getClass())) {
            ...
            if (arrays != null && arrays.size() > 0) {
                ...
                stats.put("total_rebounds", reboundMap.get("leftVal"));
                stats.put("assists", assistMap.get("leftVal"));
                stats.put("steals", stealsMap.get("leftVal"));
                stats.put("blockedshots", blocksMap.get("leftVal"));
                stats.put("turnovers", turnOverMap.get("leftVal"));
                stats.put("freethrows_made", ftMap.get("leftVal"));
                stats.put("threepoint_made", threeMap.get("leftVal"));
                stats.put("personalfouls", foulMap.get("leftVal"));
            }
        }
        return stats;
    }
