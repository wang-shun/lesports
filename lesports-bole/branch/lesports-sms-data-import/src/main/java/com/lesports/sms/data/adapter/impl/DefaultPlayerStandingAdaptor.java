...
public class DefaultPlayerStandingAdaptor extends DefualtAdaptor {
    ...
    public Boolean nextProcessor(PartnerType partnerType, Long csid, Object object) {
        try {
            ...
            TopList curentTopList = convertModelToTopList(partnerType, csid, playerStandings);
    ...
    private TopList convertModelToTopList(PartnerType type, Long csid, DefaultPlayerStanding.PlayerStandings playerStandings) {
