 ...
 */
@Service("top12MatchResultParser")
public class Top12MatchResultParser   extends Parser{
    private static Logger logger = LoggerFactory.getLogger(Top12MatchResultParser.class);

    private final String SODA_MATCH_RESULT_FILE_LOCAL_PATH = "//letv//third_part_files//soda//matchresult";
    private final String SODA_TIME_LINE_FILE_LOCAL_PATH = "//letv//third_part_files//soda//timeline";
    private final String SODA_MATCH_RESULT_FILE_DOWNLOAD_PATH = "//soda//matchresult";
    private final String SODA_TIME_LINE_FILE_DOWNLOAD_PATH = "//soda//timeline";


    public Boolean parseData(String sodaId) {
        String matchresultFile = "s8-282-2016-" + sodaId + "-timeline.xml";
        String timelineFile = "s8-282-2016-" + sodaId + "-timeline.xml";
        ...
        try {
            ...
            //下载
            downloadFile(matchresultFile,SODA_MATCH_RESULT_FILE_LOCAL_PATH,SODA_MATCH_RESULT_FILE_DOWNLOAD_PATH);
            downloadFile(timelineFile,SODA_TIME_LINE_FILE_LOCAL_PATH,SODA_TIME_LINE_FILE_DOWNLOAD_PATH);

            File xmlFile = new File(SODA_MATCH_RESULT_FILE_LOCAL_PATH+ File.separator+matchresultFile);
            ...
            String filePath = SODA_TIME_LINE_FILE_LOCAL_PATH + File.separator + timelineFile;
...
//                    }
    ...
    private Boolean downloadFile(String fileName, String localRootPath,String remotePath) {
        boolean result = true;
        ...
        try {
            ...
            boolean downloadResult = ftpUtil.downloadFile(fileName, localRootPath, remotePath);
            if (!downloadResult) {
