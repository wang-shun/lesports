 ...
 */
public class QQTeamStatsFormatter extends ElementFormatter implements Function<Map<String, Object>, Map<String, Object>> {
    @Nullable
    @Override
    public Map<String, Object> apply(Map<String, Object> input) {
        return parseJsonMap(input, QQConstants.NBATeamTotalStatPath);
    }
}