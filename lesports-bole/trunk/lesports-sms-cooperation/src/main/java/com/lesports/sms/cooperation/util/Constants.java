...
public class Constants {
    ...
    //比赛页url
    public static final String MATCH_URL = "http://sports.letv.com/match/%s.html";
    //球队页url
    public static final String TEAM_URL = "http://sports.letv.com/team/%s.html";
    ...
    //小组id对应关系
    public static final Map<String, Long> groupIdMap = Maps.newHashMap();
    //小组名称对应关系
    public static final Map<Long, String> groupNameMap = Maps.newHashMap();
    //阶段id对应关系
    public static final Map<String, Long> stageIdMap = Maps.newHashMap();
    //阶段名称对应关系
    public static final Map<Long, String> stageNameMap = Maps.newHashMap();
    //轮次id对应关系
    public static final Map<String, Long> roundIdMap = Maps.newHashMap();
    //中国参加亚冠球队
    public static final Map<Long,String> afcclMap = new HashMap<Long,String>();
    ...
    public  static final Map<Long,String> baiduWiseMap = Maps.newHashMap();
    ...
    static {
        ...
        groupIdMap.put("A", 100023000L);
        groupIdMap.put("B", 100024000L);
        groupIdMap.put("C", 100025000L);
        groupIdMap.put("D", 100026000L);
        groupIdMap.put("E", 100027000L);
        groupIdMap.put("F", 100028000L);
        groupIdMap.put("G", 100029000L);
        groupIdMap.put("H", 100030000L);


        groupNameMap.put(100023000L,"A");
        groupNameMap.put(100024000L,"B");
        groupNameMap.put(100025000L,"C");
        groupNameMap.put(100026000L,"D");
        groupNameMap.put(100027000L,"E");
        groupNameMap.put(100028000L,"F");
        groupNameMap.put(100029000L,"G");
        groupNameMap.put(100030000L,"H");

        stageIdMap.put("1/8决赛", 100078000L);
        stageIdMap.put("1/4决赛", 100079000l);
        stageIdMap.put("半决赛", 100080000L);
        stageIdMap.put("三四名决赛", 100081000L);
        stageIdMap.put("决赛", 100082000L);

        roundIdMap.put("第1轮", 100031000L);
        roundIdMap.put("第2轮", 100032000L);
        roundIdMap.put("第3轮", 100033000L);
        roundIdMap.put("第4轮", 100034000L);
        roundIdMap.put("第5轮", 100035000L);
        roundIdMap.put("第6轮", 100036000L);

        afcclMap.put(1032006L,"广州恒大");
        afcclMap.put(1035006L,"江苏苏宁");
        afcclMap.put(1041006L,"上海上港");
        afcclMap.put(1008006L,"上海申花");


        stageNameMap.put(100078000L,"1/8决赛");
        stageNameMap.put(100079000l,"1/4决赛");
        stageNameMap.put(100080000L,"半决赛");
        stageNameMap.put(100081000L,"三四名决赛");
        stageNameMap.put(100082000L,"决赛");


        baiduWiseMap.put(192001L,"ouguan");
        baiduWiseMap.put(100100001L,"oulian");
        baiduWiseMap.put(100037001L,"yingguan");
        baiduWiseMap.put(35001L,"fajia");
        baiduWiseMap.put(32001L,"dejia");
        baiduWiseMap.put(120001L,"deguobei");
        baiduWiseMap.put(177001L,"zuxiebei");
        baiduWiseMap.put(29001L,"yijia");
        baiduWiseMap.put(100228001L,"zuzongbei");
        baiduWiseMap.put(101121001L,"shequdun");
        baiduWiseMap.put(172001L,"puchao");
        baiduWiseMap.put(62001L,"mls");
        baiduWiseMap.put(180001L,"ouguanlanqiu");
        baiduWiseMap.put(100825001L,"wenwang");
        baiduWiseMap.put(503001L,"suchao");
        baiduWiseMap.put(100152001L,"qingnianouguan");
        baiduWiseMap.put(67001L,"jliansai");
        baiduWiseMap.put(100170001L,"aochao");
        baiduWiseMap.put(100920001L,"stankovic");
