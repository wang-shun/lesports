 ...
 */
@Service("defaultLiveEventProcessor")
public class DefaultLiveEventProcessor extends BeanProcessor {
    ...
    public Boolean process(Object object) {
        ...
        try {
            ...
            Episode currentEpisode = QmtSbcEpisodeInternalApis.getEpisodesByMidAndCountryAndLanguage(matchActionList.get(0).getMid(), CountryCode.CN, LanguageCode.ZH_CN);
