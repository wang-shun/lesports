...
public abstract class Parser {
    ...
    public Map<String, Object> getSportrardTeamRankStats(org.dom4j.Element element, Map<String, String> paths) {
        ...
        while (iter.hasNext()) {
            ...
            if (functions.length == 3) {
                ...
                if (functions[1].equals("+")) {
                    ...
                    try {
                        valueEnd = Double.valueOf(left) / Double.valueOf(right);
            ...
            if (key.contains("winPic")) {
                valueEnd = CommonUtil.getPercentFormat(valueEnd.toString());
            } else {
                valueEnd = new Double(valueEnd.toString()).intValue();
            }
            stats.put(key, valueEnd.toString());
        }
        return stats;
    }
