...
public class StatConstats {
    ...
    public static final Map<String, String> sportBaseketTeamRankStatsPath = new HashMap<>();
    public static final Map<String, String> sportSoccerTeamRankStatsPath = new HashMap<>();
    ...
    static {
        ...
        //
        sportBaseketTeamRankStatsPath.put("rank", "./LeagueTableColumn[@key='positionTotal']/@value");
        sportBaseketTeamRankStatsPath.put("matchNumber", "./LeagueTableColumn[@key='matchesTotal']/@value");
        sportBaseketTeamRankStatsPath.put("teamScore", "./LeagueTableColumn[@key='pointsTotal']/@value");
        sportBaseketTeamRankStatsPath.put("winMatch", "./LeagueTableColumn[@key='winTotal']/@value");
        sportBaseketTeamRankStatsPath.put("lossMatch", "./LeagueTableColumn[@key='lossTotal']/@value");
        sportBaseketTeamRankStatsPath.put("goal", "./LeagueTableColumn[@key='goalsForTotal']/@value|/|./LeagueTableColumn[@key='matchesTotal']/@value");
        sportBaseketTeamRankStatsPath.put("fumble", "./LeagueTableColumn[@key='goalsAgainstTotal']/@value|/|./LeagueTableColumn[@key='matchesTotal']/@value");
        sportBaseketTeamRankStatsPath.put("winPic", "./LeagueTableColumn[@key='winTotal']/@value|/|./LeagueTableColumn[@key='matchesTotal']/@value");
        sportBaseketTeamRankStatsPath.put("goalDiffer", "./LeagueTableColumn[@key='goalDiffTotal']/@value");
        //
        sportSoccerTeamRankStatsPath.put("rank", "./LeagueTableColumn[@key='positionTotal']/@value");
        sportSoccerTeamRankStatsPath.put("matchNumber", "./LeagueTableColumn[@key='matchesTotal']/@value");
        sportSoccerTeamRankStatsPath.put("teamScore", "./LeagueTableColumn[@key='pointsTotal']/@value");
        sportSoccerTeamRankStatsPath.put("winMatch", "./LeagueTableColumn[@key='winTotal']/@value");
        sportSoccerTeamRankStatsPath.put("flatMatch", "./LeagueTableColumn[@key='drawTotal']/@value");
        sportSoccerTeamRankStatsPath.put("lossMatch", "./LeagueTableColumn[@key='lossTotal']/@value");
        sportSoccerTeamRankStatsPath.put("goal", "./LeagueTableColumn[@key='goalsForTotal']/@value");
        sportSoccerTeamRankStatsPath.put("fumble", "./LeagueTableColumn[@key='goalsAgainstTotal']/@value");
        sportSoccerTeamRankStatsPath.put("goalDiffer", "./LeagueTableColumn[@key='goalDiffTotal']/@value");
