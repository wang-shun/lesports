...
import static com.lesports.id.api.TIdConstants.OFFSET_AREA;
import static com.lesports.id.api.TIdConstants.OFFSET_BASE;
...
public class IdServiceImpl implements IdService {
    ...
    private static final int ID_AREA_CODE = LeProperties.getInt("id.area.code", 01);

    static {
        if (ID_AREA_CODE > 100) {
            throw new IllegalStateException("id.area.code must below 100");
        }
    }
    ...
    public long nextId(IdType type) {
        ...
        return id * OFFSET_BASE * OFFSET_AREA + ID_AREA_CODE * OFFSET_BASE + type.getValue();
    }
