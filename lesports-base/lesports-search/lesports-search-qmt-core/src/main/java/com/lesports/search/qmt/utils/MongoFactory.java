...
import org.springframework.data.mongodb.core.convert.QmtMongoConverter;
...
public class MongoFactory {
	...
	@Resource(name = "noClassMongoConverter")
	...
	public MongoTemplate getMongoTemplateMannually(String dbName) {
	...
	public MongoTemplate getMongoTemplate(String dbName) {
		SimpleMongoDbFactory factory = new SimpleMongoDbFactory(mongoClient, dbName);
		return new MongoTemplate(factory, /*converter*/null);
	}
