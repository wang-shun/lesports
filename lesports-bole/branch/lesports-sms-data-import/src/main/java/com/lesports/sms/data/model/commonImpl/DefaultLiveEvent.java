...
import com.lesports.utils.xml.annotation.XPathSportrard2;
...
public class DefaultLiveEvent extends DefaultModel {
    @XPathStats(value = "sports-statistics/sports-scores/nba-plybyplay")
    ...
    public static class LiveModel {
        ...
        @XPathSportrard(formatter = CardTypeFormatter.class, value = "./Cards/Card")
