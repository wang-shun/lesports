...
//            newestShowEpisode.addContent(LeDateUtils.formatYYYY_MM_DD(LeDateUtils.parseYYYYMMDDHHMMSS(episodes.get(0).getCreateAt())));
            newestShowEpisode.addContent(LeDateUtils.formatYYYY_MM_DD(new Date()));
