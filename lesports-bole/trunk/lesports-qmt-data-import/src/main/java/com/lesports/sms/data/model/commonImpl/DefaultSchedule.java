...
import com.lesports.sms.data.util.formatter.RoundFormatter;
import com.lesports.sms.data.util.formatter.StageFormatter;
...
public class DefaultSchedule extends DefaultModel implements Serializable {
    ...
    public static class ScheduleModel {
        ...
        @XPathSportrard(formatter = StageFormatter.class, value = "./Roundinfo/@roundName")
