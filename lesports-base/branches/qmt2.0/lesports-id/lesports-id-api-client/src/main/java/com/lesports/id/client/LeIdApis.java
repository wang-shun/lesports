...
public class LeIdApis {
    ...
    /**
     * 媒资video id转成乐视体育视频id
     * @param mmsVideoId 媒资视频id
     * @return 乐视体育视频id
     */
    public static long convertMmsVideoIdToLeSportsVideoId(long mmsVideoId) {
        return mmsVideoId * 1000 + IdType.VIDEO.getValue();
    }

    /**
     * 乐视体育视频id转成媒资视频id
     * @param videoId 乐视体育视频id
     * @return 媒资视频id
     * @throws Exception
     */
    public static long convertLeSportsVideoIdToMmsVideoId(long videoId) throws Exception {
        if (IdType.VIDEO == checkIdTye(videoId)) {
            return videoId / 1000;
        }
        throw new Exception("非法的乐视体育视频id");
    }
