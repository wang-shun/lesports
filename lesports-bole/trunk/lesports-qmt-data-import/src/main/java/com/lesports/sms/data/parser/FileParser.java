...
import com.lesports.sms.data.util.xml.Parser;
import com.lesports.sms.data.util.xml.ParserFactory2;
...
public class FileParser {
    ...
    @Resource
    DefaultLiveEventAdaptor defaultLiveEventAdaptor;
    @Resource
    DefaultMatchReviewAdaptor defaultMatchReviewAdaptor;
    ...
    private List<Object> getAllObjects(String code, String annotationType, String fileUrl) {
        FileInputStream fileInputStream = FileUtil.getInputStreamByFileURL(fileUrl, Constants.defaultDownloadPathPrex);
    ...
    private DefualtAdaptor getAdaptorByCode(String code) {
        ...
        else if (code.equals("MATCH-PREVIEW")) return defaultMatchReviewAdaptor;
        ...
        else if (code.equals("LIVE-EVENT")) return defaultLiveEventAdaptor;
        return null;
    }

    private Class getClassByCode(String code) {
        if (code.equals("SCHEDULE")) return DefaultSchedule.class;
        else if (code.equals("MATCH-PREVIEW")) return DefaultMatchReviews.class;
        ...
        else if (code.equals("LIVE-EVENT")) return DefaultLiveEvent.class;
        return null;
    }
