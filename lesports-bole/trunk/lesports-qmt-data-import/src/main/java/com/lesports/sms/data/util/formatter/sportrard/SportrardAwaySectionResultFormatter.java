 ...
 */
public class SportrardAwaySectionResultFormatter extends ElementFormatter implements Function<Element, Map<Integer, Match.SectionResult>> {
    @Nullable
    @Override
    public Map<Integer, Match.SectionResult> apply(Element scores) {
        int hScore = 0;
        int ftScore = 0;
        int otScore = 0;
        int atScore = 0;
            ...
            if (scores != null) {
                ...
                while (scoreIterator.hasNext()) {
                    ...
                    if (score.attributeValue("type").equals("Period1")) {
                        hScore = CommonUtil.parseInt(score.elementText("Team2"), 0);
                    ...
                    if (score.attributeValue("type").equals("Normaltime")) {
                        ftScore = CommonUtil.parseInt(score.elementText("Team2"), 0);
                        Match.SectionResult sectionResult = new Match.SectionResult();
                    ...
                    if (score.attributeValue("type").equals("Overtime")) {
                        otScore = CommonUtil.parseInt(score.elementText("Team2"), 0);
                        Match.SectionResult sectionResult = new Match.SectionResult();
                    ...
                    if (score.attributeValue("type").equals("Penalties")) {
                        atScore = CommonUtil.parseInt(score.elementText("Team2"), 0);
                        Match.SectionResult sectionResult = new Match.SectionResult();
